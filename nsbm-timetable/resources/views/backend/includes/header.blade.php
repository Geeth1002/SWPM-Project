<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ asset('img/backend/brand/logo.svg') }}" width="100" height="50" alt="NSBM Logo">
        <img class="navbar-brand-minimized" src="{{ asset('img/backend/brand/logo.svg') }}" width="100" height="50" alt="NSBM Logo">
    </a>
